...
# -*- coding: utf-8 -*-
"""
Created on Fri May 29 17:22:48 2026
...
# Get list consecutive_missing for df_result
column = 'PM_temperature'
consecutive_missing = get_missing_list(df_result, column)

# Duplicate df_result
df_result_preprocessed = df_result.copy()

# Interpolate missing values that are not longer than 1 hour
threshold = 12
interpolate_missing_values(df_result_preprocessed, column, consecutive_missing, threshold)

# Get list consecutive_missing for df_result_preprocessed
consecutive_missing = get_missing_list(df_result_preprocessed, column)
timeframe = '1d'
plot_missing_values(df_result_preprocessed, ['PM_temperature', 'SK_temperature'], consecutive_missing, timeframe)

...
# -*- coding: utf-8 -*-
"""
Created on Fri May 29 17:59:49 2026
...
column = 'PM_atmospheric_pressure'
...
# Plot the remaining missing values that are longer than 1 hour
consecutive_missing = get_missing_list(df_result_preprocessed, column)
timeframe = '1d'
plot_missing_values(df_result_preprocessed, column, consecutive_missing, timeframe)

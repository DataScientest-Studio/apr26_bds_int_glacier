...
measurement_station = 'Pegelstation Meteorologie'
...
df.loc[df['name of column'] == column_name, 'measurement instrument'] = '°C'
df.loc[df['name of column'] == column_name, 'measurement unit of variable'] = 'Pt-100 temperature sensor with ventilation fan'
...
df.loc[df['name of column'] == column_name, 'name of measurement station'] = measurement_station
df.loc[df['name of column'] == column_name, 'measurement instrument'] = 'hPa'
df.loc[df['name of column'] == column_name, 'measurement unit of variable'] = 'Barometric pressure sensor, Druck, RPT 410h'
df.loc[df['name of column'] == column_name, 'description'] = ''
...
df.loc[df['name of column'] == column_name, 'measurement unit of variable'] = 'Hair hygrometer, Thies Clima'
df.loc[df['name of column'] == column_name, 'description'] = ''
...
df.loc[df['name of column'] == column_name, 'name of measurement station'] = measurement_station
df.loc[df['name of column'] == column_name, 'measurement instrument'] = 'mm/5 min'
df.loc[df['name of column'] == column_name, 'measurement unit of variable'] = 'Tipping bucket, Gertsch, unheated'
df.loc[df['name of column'] == column_name, 'description'] = ''
...
df.loc[df['name of column'] == column_name, 'name of measurement station'] = measurement_station
df.loc[df['name of column'] == column_name, 'measurement instrument'] = 'mm'
df.loc[df['name of column'] == column_name, 'measurement unit of variable'] = 'Weighing rain gauge, Belfort'
df.loc[df['name of column'] == column_name, 'description'] = ''
...
df.loc[df['name of column'] == column_name, 'name of measurement station'] = measurement_station
df.loc[df['name of column'] == column_name, 'measurement instrument'] = 'm'
df.loc[df['name of column'] == column_name, 'measurement unit of variable'] = 'Sonic Ranging Sensor, Campbell Scientific, SR50'
df.loc[df['name of column'] == column_name, 'description'] = ''
...
df.loc[df['name of column'] == column_name, 'name of measurement station'] = measurement_station
df.loc[df['name of column'] == column_name, 'measurement instrument'] = 'm/s'
df.loc[df['name of column'] == column_name, 'measurement unit of variable'] = 'Anemometer, Thies Clima'
df.loc[df['name of column'] == column_name, 'description'] = ''
...
df.loc[df['name of column'] == column_name, 'name of measurement station'] = measurement_station
df.loc[df['name of column'] == column_name, 'measurement instrument'] = 'deg'
df.loc[df['name of column'] == column_name, 'measurement unit of variable'] = 'Wind vane, Thies Clima'
df.loc[df['name of column'] == column_name, 'description'] = ''
...
df.loc[df['name of column'] == column_name, 'name of measurement station'] = measurement_station
df.loc[df['name of column'] == column_name, 'measurement instrument'] = 'W/m**2'
df.loc[df['name of column'] == column_name, 'measurement unit of variable'] = 'Albedometer, Kipp & Zonen, CM7B, unventilated'
df.loc[df['name of column'] == column_name, 'description'] = ''
...
# variable for current measurement station
measurement_station = 'Schwarzkögele'
...
# variable for current measurement station
measurement_station = 'Pegelstation Hydrologie'

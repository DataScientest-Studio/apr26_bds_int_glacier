...
df_result = pd.read_csv('preprocessed_meteohydrodata2026-05-26.csv', index_col='TIMESTAMP')
df_result.index = pd.to_datetime(df_result.index)

df_result_pre = pd.read_csv('mod_meteohydrodata.csv', index_col='TIMESTAMP')
df_result_pre.index = pd.to_datetime(df_result_pre.index)
